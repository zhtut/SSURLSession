...
public protocol SSURLSessionDataDelegate : SSURLSessionTaskDelegate {
     ...
     */
    func urlSession(_ session: SSURLSession, dataTask: SSURLSessionDataTask, didBecome downloadTask: SSURLSessionDownloadTask)
     ...
     */
    func urlSession(_ session: SSURLSession, dataTask: SSURLSessionDataTask, didBecome streamTask: SSURLSessionStreamTask)
...
extension SSURLSessionDataDelegate {
    ...
    public func urlSession(_ session: SSURLSession, dataTask: SSURLSessionDataTask, didBecome downloadTask: SSURLSessionDownloadTask) { }
    
    public func urlSession(_ session: SSURLSession, dataTask: SSURLSessionDataTask, didBecome streamTask: SSURLSessionStreamTask) { }
...
public protocol SSURLSessionDownloadDelegate : SSURLSessionTaskDelegate {
     ...
     * still be called.
     */
    func urlSession(_ session: SSURLSession, downloadTask: SSURLSessionDownloadTask, didFinishDownloadingTo location: URL)
    
    /* Sent periodically to notify the delegate of download progress. */
    func urlSession(_ session: SSURLSession, downloadTask: SSURLSessionDownloadTask, didWriteData bytesWritten: Int64, totalBytesWritten: Int64, totalBytesExpectedToWrite: Int64)
     ...
     * data.
     */
    func urlSession(_ session: SSURLSession, downloadTask: SSURLSessionDownloadTask, didResumeAtOffset fileOffset: Int64, expectedTotalBytes: Int64)
}

extension SSURLSessionDownloadDelegate {
    public func urlSession(_ session: SSURLSession, downloadTask: SSURLSessionDownloadTask, didWriteData bytesWritten: Int64, totalBytesWritten: Int64, totalBytesExpectedToWrite: Int64) { }
    
    public func urlSession(_ session: SSURLSession, downloadTask: SSURLSessionDownloadTask, didResumeAtOffset fileOffset: Int64, expectedTotalBytes: Int64) { }
}

public protocol URLSessionStreamDelegate : SSURLSessionTaskDelegate {
    ...
    func urlSession(_ session: SSURLSession, readClosedFor streamTask: SSURLSessionStreamTask)
    
    /* Indicates that the write side of a connection has been closed.
     * Any outstanding writes complete, but future writes will immediately
     * fail.
     */
    func urlSession(_ session: SSURLSession, writeClosedFor streamTask: SSURLSessionStreamTask)
    ...
    func urlSession(_ session: SSURLSession, betterRouteDiscoveredFor streamTask: SSURLSessionStreamTask)
     ...
     */
    func urlSession(_ session: SSURLSession, streamTask: SSURLSessionStreamTask, didBecome inputStream: InputStream, outputStream: OutputStream)
}

extension URLSessionStreamDelegate {
    public func urlSession(_ session: SSURLSession, readClosedFor streamTask: SSURLSessionStreamTask) { }
    
    public func urlSession(_ session: SSURLSession, writeClosedFor streamTask: SSURLSessionStreamTask) { }
    
    public func urlSession(_ session: SSURLSession, betterRouteDiscoveredFor streamTask: SSURLSessionStreamTask) { }
    
    public func urlSession(_ session: SSURLSession, streamTask: SSURLSessionStreamTask, didBecome inputStream: InputStream, outputStream: OutputStream) { }
}
